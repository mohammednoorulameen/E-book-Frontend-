...
export default function Header() {
  ...
  return (
    <header>
      {/* Top Bar */}
      <div className="py-4 px-5 bg-white fixed top-0 w-full z-40 shadow-sm">
        <div className="max-w-screen-xl mx-auto flex items-center justify-between gap-5">
          {/* Logo */}
          <div className="flex items-center gap-2 text-2xl font-bold text-black">
            <FaBook />
          ...
          <div className="hidden sm:flex items-center gap-11 text-lg ml-auto">
            <div className="relative group">
              ...
              <div className="absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-lg py-2 z-50 opacity-0 scale-95 invisible group-hover:opacity-100 group-hover:scale-100 group-hover:visible transition-all duration-300">
                {userData ? (
                  <Link
                    to="/account"
                    className="flex items-center gap-2 px-4 py-2 hover:bg-gray-100"
            ...
            <Link
              ...
              className="flex items-center gap-1 text-gray-800 relative"
            >
              <FaHome className="w-6 h-6 stroke-black stroke-2 " />
            </Link>
            ...
            <Link
              ...
              className="flex items-center gap-1 text-gray-800 relative"
            >
              <FaCompass className="w-6 h-6 stroke-black stroke-2 " />
            </Link>
          ...
          <div
            className={`fixed bottom-0 left-0 w-full bg-white flex justify-around py-2 sm:hidden z-50 shadow-md transition-transform duration-300 ${
              showBottomBar ? "translate-y-0" : "translate-y-full"
            }`}
          >
            <Link to={"/"} className="flex flex-col items-center text-gray-800">
              <HomeIcon className="w-5 h-5" />
              <span className="text-xs">Home</span>
            </Link>
            <Link
            ...
            <Link
              to={"/cart"}
              className="flex flex-col items-center text-gray-800 relative"
            >
              <ShoppingCartIcon className="w-5 h-5" />
              {!isLoading && itemCount > 0 && (
                <span className="absolute -top-1 right-2 bg-red-500 text-white text-xs font-bold rounded-full w-4 h-4 flex items-center justify-center">
            ...
            >
              <UserIcon className="w-5 h-5" />
              <span className="text-xs">{userData ? "Profile" : "Login"}</span>
            </Link>
          </div>
        </div>
      </div>
